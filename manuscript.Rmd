...
One such example is the well-known `lme4` package [@bates2014fitting] for generalized linear mixed-effects models, which is partly based on `NLopt`.
...
Last, we hope to arrive at an evaluation scheme that incentivizes the development of open-source research software.
