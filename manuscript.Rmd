...
For another example, the pdc package [@pdc-paper] offers functions to cluster time series based on relative complexity. <!-- Here is a sentence missing about why this is an example that shows the invalidity of citation based metrics -->
...
To this end, we emphasize a more fine-grained assessment of rigor and a qualitative statement on impact, in which software authors should argue in how far their project paved the way for other scientific endeavors.
