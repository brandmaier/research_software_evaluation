...
Rigor means implementing highest standards and best practices for ensuring transparency, correctness and reusability of a software.
...
We therefore argue that qualitative merrit statements are much more useful to assess impact of research software.
...
The date of the first fully functional public version is a central field in the proposal as it serves as a denominator in computing citations relative to the software age.
Besides the problem of creating an ad hoc citation metric, this date is difficult to determine and to verify.
In our own experience, research software often evolves driven by time constraints and the need for specific functionality, not according to feature completeness.
...
Feature completeness is not a valid measure in these cases.
...
## ID 8: License
At present, the question of whether the software is open source is not used in the computation of a treshold for phase one of the assessment procedure.
However, we think an open license is central for assessing both rigor and (potential) impact.
...
Therefore, we propose to either score a package's license, giving points to open-source licenses (those approved in a review process by the Open Source Society (https://opensource.org/licenses). <!--Alternatively, one may indirectly score openness by assessing the indicators of rigor as discussed in the second part of this commentary, where it is only possible to gain points for certain aspects of rigor if the software is open-source.-->
...
We instead propose to assess "usage" or impact independently of rigor.
