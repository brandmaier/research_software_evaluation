...
Based on four basic principles of a more responsible research assessment in academic hiring and promotion processes [@schonbrodt2022responsible], @gartner2022responsible suggest a specific implementation to broaden the range of what constitutes research contributions. Gaertner et al. provide evaluation schemes for published manuscripts, published datasets, and software contributions.
Why are research software contributions important academic contributions? We would like to respond with a quote from the Science Code Manifesto (http://sciencecodemanifesto.org/):
...
Yet, despite the heavy reliance on computational infrastructure, the current academic infrastructure does not adequately incentivice good software engineering practice that we would expect from a research software engineer [@baxter2012research]. 
...
Complementing the quantitative aspect of impact, we suggest to introduce a mandatory qualitative judgement on the impact of the software, which fits with what the others proposed as indicator "merit / impact statement". In our view, researchers should be requested to indicate at least one (and up to three) empirical research projects that directly benefitted from the software contributions they made. We believe this is a fair assessment of the real impact no matter whether someone contributed documentation/tutorial to run certain types of models, whether someone contributed a specific feature that enabled a given research project to run their analysis, or whether someone is the author of the entire package.
