...
However, citations suffer from serious shortcomings when used to evaluate the impact of research software, particularly, when used comparatively in the context of hire and promotion.
...
We believe that the current proposal must aim to better reflect the distinction between rigor and impact.
