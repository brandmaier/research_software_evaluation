...
We instead propose to assess the different aspects of rigor separately, more sharply defined, and also assess "usage" indepentently from quality.
...
## documentation
## open source
## bug reporting and disclosure in changelogs
