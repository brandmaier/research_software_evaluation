...
Put the contact information and any acknowledgements here. ORCID to all author if available. Corresponding author mandatory.
These headings after the article but before the references are required. Feel free to add other headings (e.g., acknowledgments) if you need to.

## Conflict of Interest and Funding

Add a statement about conflict of interest. If you have no conflict of interest to declare, please state that. Add a statement about how the research was funded. If there was no specific funding please state that.

## Author Contributions

Explain the contribution of each authors. If you are the single author, please spell it out anyway for future proper credit of your contributions and meta-science studies. 
The Contributor Roles Taxonomy can be helpful. https://www.casrai.org/credit.html 
Please explain how the author names order connects to the contribution (e.g. alphabetical, ranked, or random order).
